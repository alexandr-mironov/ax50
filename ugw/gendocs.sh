...
/** \defgroup FAPI_HS Hotspot
*   @ingroup FAPI
    \brief Provides functions to get or set the configurations for hotspot entity through the
           interaction between the HS CLI and FAPI.
*/
