...
#endif
	ppa_reg_export_fn(PPA_SESSION_REFCNT_INC_FN,   (uint32_t)ppa_pitem_refcnt_inc, "ppa_hook_pitem_refcnt_inc", (uint32_t *)&ppa_hook_pitem_refcnt_inc_fn, (uint32_t)ppa_session_refcnt_inc_fn);
	ppa_reg_export_fn(PPA_SESSION_REFCNT_DEC_FN,   (uint32_t)ppa_pitem_refcnt_dec, "ppa_hook_pitem_refcnt_dec", (uint32_t *)&ppa_hook_pitem_refcnt_dec_fn, (uint32_t)ppa_session_refcnt_dec_fn);
