...
#define DLRX_GRX330_BOARD_CFG 0
...
#else
	#define DLRX_DDR_CE5DESC_BASE                           \
		(volatile unsigned int *)(RX_CFG_CTXT_BUF_BASE + 0x2ae00 + 0x22000 + 0x800 + 0x10)
#endif
#if defined(CONFIG_ACCL_11AC_CS2)
	#define DLRX_CE5_RESOURCES_BASE                         \
		(volatile unsigned int *)(RX_CFG_CTXT_BUF_BASE + 0x2b200 + 0x22000 + 0x800 + 0x10)
#endif
	/* 2048 * 512 Bytes (2e000 -*/
	#define DLRX_DDR_CE5BUF_BASE                            \
...
#ifdef USING_BBCPU_SRAM
	#define DLRX_TARGET_CE5_READ_INDEX(base)                \
		(volatile unsigned int *)(DLRX_BBCPU_CE5_CTXT_RD_IDX_BASE)
	...
	#define DLRX_TARGET_CE5_IS_HOST_INDEX(base)               \
		(volatile unsigned int *)(pcie_base + ((base+0x30)>>2))
#endif
...
#define HTT_TX_T2H_MSG_TYPE_TX_INSPECT_IND 				0x16
#define HTT_TX_T2H_MSG_TYPE_TX_FETCH_CONF 				0x17
#define HTT_TX_T2H_MSG_TYPE_TX_MODE_SWITCH_IND			0x30
