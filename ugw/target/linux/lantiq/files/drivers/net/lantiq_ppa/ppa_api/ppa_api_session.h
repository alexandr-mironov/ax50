...
static inline
uint32_t ppa_is_PPTPSession(struct session_list_item* const p_item)
{
	return (p_item->flag2 & SESSION_FLAG2_PPTP);
}

static inline
void ppa_set_PPTPSession(struct session_list_item* p_item)
{
