...
define KernelPackage/puma_l2tpv2
  SUBMENU:=Intel
  TITLE:=pppp support for async serial ports
  KCONFIG:=CONFIG_PPP_ASYNC=y
endef

define KernelPackage/puma_l2tpv2/description
 PPP support for async serial ports
endef

$(eval $(call KernelPackage,puma_l2tpv2))
