...
#ifdef NO_DOXY
extern int32_t (*ppa_pptp_get_callid_fn)(struct net_device *ppp_dev,struct ppp_channel *chan);
extern int32_t (*ppa_pptp_get_seq_num_fn)(struct net_device *ppp_dev,void *chan,int *sent_seq,int *rcv_seq);
extern int32_t (*ppa_pptp_get_outer_src_dst_addr_fn)(struct net_device *ppp_dev,void *chan,uint32_t *outer_srcip,uint32_t *outer_dstip,struct rtable *rut,uint8_t *mac,struct net_device *base_dev);
extern int32_t (*ppa_get_pptp_hdrlen_fn)(struct net_device *ppp_dev,void *chan);
extern int32_t (*ppa_form_pptp_hdr_fn)(struct net_device *ppp_dev,void *chan,void *hdr);
extern int32_t (*ppa_update_pptp_hdr_fn)(struct net_device *ppp_dev,void *chan, void *hdr,int len);
extern int32_t (*ppa_pptp_rcv_fn)(struct net_device *ppp_dev,struct ppp_channel *chan, struct sk_buff *skb,uint32_t pptp_gre_header_len );
extern int32_t (*ppa_check_pptp_ack_flag_fn)(struct sk_buff *skb);
#else
extern int32_t ppa_pptp_get_callid_fn(struct net_device *ppp_dev,struct ppp_channel *chan);
extern int32_t ppa_pptp_get_seq_num_fn(struct net_device *ppp_dev,void *chan,int *sent_seq,int *rcv_seq);
extern int32_t ppa_pptp_get_outer_src_dst_addr_fn(struct net_device *ppp_dev,void *chan,uint32_t *outer_srcip,uint32_t *outer_dstip,struct rtable *rut,uint8_t *mac);
extern int32_t ppa_get_pptp_hdrlen_fn(struct net_device *ppp_dev,void *chan);
extern int32_t ppa_form_pptp_hdr_fn(struct net_device *ppp_dev,void *chan,void *hdr);
extern int32_t ppa_update_pptp_hdr_fn(struct net_device *ppp_dev,void *chan, void *hdr,int len);
extern int32_t ppa_pptp_rcv_fn(struct net_device *ppp_dev,struct ppp_channel *chan, struct sk_buff *skb);
extern int32_t ppa_check_pptp_ack_flag_fn(struct sk_buff *skb);
#endif
#endif
#ifdef NO_DOXY
extern void* (*ppa_get_pptp_info_fn)(struct net_device *ppp_dev);
#else
extern void* ppa_get_pptp_info_fn(struct net_device *ppp_dev);
#endif
