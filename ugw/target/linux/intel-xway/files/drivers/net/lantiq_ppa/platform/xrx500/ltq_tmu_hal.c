...
//					__FUNCTION__, dp_subif.port_id,dp_subif.subif,(tmu_res + i)->tmu_port,(tmu_res+i)->sch_id[0],(tmu_res+i)->q_id);
			if((flags & PPA_QOS_Q_F_INGRESS) == PPA_QOS_Q_F_INGRESS) {
				...
				(tmu_hal_user_sub_interface_ingress_info + ((tmu_res + i)->tmu_port * TMU_HAL_MAX_SUB_IFID_PER_PORT) + dp_subif.subif)->user_queue[0].qmap[MAX_TC_NUM-1] = 0;
				...
				(tmu_hal_user_sub_interface_info + ((tmu_res + i)->tmu_port * TMU_HAL_MAX_SUB_IFID_PER_PORT) )->user_queue[0].qmap[MAX_TC_NUM-1] = 0;
