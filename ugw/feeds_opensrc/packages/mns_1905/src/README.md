...
This software is covered by the "BSD 3-Clause License", a copy of which is
contained in file "LICENSE" (in the same folder as this "README.md").

This is a very short and simple license that lets you do whatever you want with
the software as long as you include a copy of the license and copyright notice
with the code (in case you decide to distribute it) and don't try to hold me
liable for any damage it might cause (that would be *very* mean of you after
all the free work I'm doing here!)

In particular you can use it in closed source projects without worrying about
having to publish your modifications or original closed source code.

> Note, however, that even if the license lets you keep your modifications, I
> would really appreciate it if you decided to share them back with us!

For more information regarding this license check the following links:
